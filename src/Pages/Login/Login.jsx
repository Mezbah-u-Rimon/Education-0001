...
const Login = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto flex flex-col justify-center items-center py-24 ">
            <h1 className="pb-16 text-3xl font-bold"> Login Your Account </h1>
            <form onSubmit={handleLogin} className="relative flex w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                ...
                <div className="p-6 pt-0">
                    ...
                    <p className="mt-6 flex justify-center font-bold text-sm leading-normal text-gray-500 antialiased">
